...
var require_AttributeMap = __commonJS({
  "node_modules/quill-delta/dist/AttributeMap.js"(exports) {
    ...
    (function(AttributeMap3) {
      ...
      AttributeMap3.transform = transform;
    })(AttributeMap2 || (AttributeMap2 = {}));
    exports.default = AttributeMap2;
  }
});
...
var require_Delta = __commonJS({
  "node_modules/quill-delta/dist/Delta.js"(exports, module) {
    ...
    Delta4.Op = Op_1.default;
    Delta4.OpIterator = OpIterator_1.default;
    Delta4.AttributeMap = AttributeMap_1.default;
    Delta4.handlers = {};
    exports.default = Delta4;
    if (typeof module === "object") {
      module.exports = Delta4;
      module.exports.default = Delta4;
    }
  }
});
...
var createRegistryWithFormats = (formats, sourceRegistry, debug5) => {
  ...
  formats.forEach((name) => {
    ...
    if (!format) {
      debug5.error(`Cannot register "${name}" specified in "formats" config. Are you sure it was registered?`);
    }
    let iterations = 0;
    while (format) {
      ...
      if (iterations > MAX_REGISTER_ITERATIONS) {
        debug5.error(`Cycle detected in registering blot requiredContainer: "${name}"`);
        break;
      }
    }
  });
...
//# sourceMappingURL=chunk-NW76ZQRY.js.map

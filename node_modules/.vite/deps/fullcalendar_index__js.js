...
var MultiMonthView = class extends DateComponent {
  ...
  render() {
    ...
    return y(ViewContainer, { elRef: this.scrollElRef, elClasses: rootClassNames, viewSpec: context.viewSpec }, monthDateProfiles.map((monthDateProfile, i3) => {
      const monthStr = formatIsoMonthStr(monthDateProfile.currentRange.start);
      return y(SingleMonth, Object.assign({}, props, { key: monthStr, isoDateStr: monthStr, elRef: i3 === 0 ? this.firstMonthElRef : void 0, titleFormat: monthTitleFormat, dateProfile: monthDateProfile, width: monthWidthPct, tableWidth: monthTableWidth, clientWidth, clientHeight }));
    }));
  }
  componentDidMount() {
    this.updateSize();
...
globalPlugins.push(index, index2, index3, index4, index5);
export {
  Calendar,
...
//# sourceMappingURL=fullcalendar_index__js.js.map
